...
Заложить ресурные требования, с возможность роста количества источников, так-же количество сроков хранения в базе данных как пример (PCI DSS).

Обеспечение архивирования данных.

Предусмотреть pool лицензий, на ПО.

Предусмотреть тех. подержку существующего ПО.
